...
% todo Die Aktivitäten passen nicht wirklich zu meinem Ablauf, vllt kann man hier abgrenzen und sagen "da in dieser Arbeit nur eine abgewandelte Form des HCD Prozesses genutzt wird, werden die Aktivitäten nur kurz beschrieben"

Der HCD-Prozess besteht aus vier sich wiederholenden Hauptaktivitäten. Zuerst kommt das Verstehen und Spezifizieren des Nutzungskontextes, bei dem die Nutzer, ihre Aufgaben und die Umgebung analysiert werden. 
Danach folgt das Spezifizieren der Nutzungsanforderungen, bei dem die Anforderungen an das System basierend aus den Ergebnissen aus Phase eins abgeleitet werden. 
Im dritten Schritt wird dann ein erster Prototyp des Systems gestaltet und entwickelt. Dieser Designprototyp sollte möglichst den zuvor erläuterten Interaktionsprinzipien aus ISO 9241-110 entsprechen, um eine gute Usability und User Experience zu gewährleisten. In dieser Phase sollte das Design auch immer wieder mit den Nutzern und den Entwicklern kommuniziert werden, um sicherzustellen, dass es deren Bedürfnissen und den technischen Möglichkeiten entspricht.
Die vierte und letzte Phase ist die Evaluierung der Lösung. Hier wird das System getestet und bewertet, um festzustellen, ob es die Anforderungen erfüllt und eine gute Usability aufweist. Diese Evaluierung sollte nutzerzentriert sein. Das bedeutet, dass echte Nutzer das System testen und Feedback geben, um Probleme zu identifizieren und Verbesserungen vorzunehmen. Die meistgenutzten Methoden dazu sind nutzerbasiertes Testen und die heuristische, expertenbasierte Evaluation. % src: ISO 9241-210, p. 17
% src (absatz): ISO 9241-210, p. 10-17

% todo Die Evaluationsmethoden werden in Kapitel XY noch näher erläutert.
