...
Komplexer werdende Systeme führen häufig zu einer erhöhten kognitiven Last für die Nutzer. Sie müssen sich mehr Abläufe, Funktionen, Bedienmöglichkeiten und Shortcuts merken. Das Problem dabei: Der Mensch hat nur eine begrenzte Kapazität im Arbeitsgedächtnis, um Informationen zu verarbeiten und zu speichern. % verify in: Cognitive Load Theory, Sweller 1988 % nosrc
...
Donald (Don) Norman, Professor für Kognitionswissenschaften und Design, hat in seinen Büchern The Design of Everyday Things und The Invisible Computer die wesentlichen psychologischen Vorgänge im menschlichen Gehirn bei der Nutzung von Systemen analysiert und Ansätze vorgestellt die Nutzbarkeit der Systeme zu verbessern und die kognitive Last für die Nutzer zu reduzieren. 
...
Normans Designprinzipien gehen einher mit der von John Sweller 1988 entwickelten Cognitive Load Theory (CLT). Diese Theorie beschäftigt sich mit der kognitiven Last, die bei der Informationsverarbeitung im Arbeitsgedächtnis entsteht. % src: Cognitive Load Theory, Sweller 1988
Ein Mensch kann meist nur eine begrenzte Menge an Informationen gleichzeitig im Arbeitsgedächtnis verarbeiten. Diese EInschränkung macht es notwendig, die kognitive Last zu managen, um effektives Lernen und Problemlösen zu ermöglichen. % src: Cognitive Load Theory, Sweller 1988 
% verify page
% src 2: DOET p. 100
...
Die intrinsische Last bezieht sich auf die Komplexität der zu lernenden Aufgabe selbst. % nosrc
Ist eine Aufgabe komplexer, erfordert sie mehr kognitive Ressourcen, um sie zu verstehen und zu bewältigen. % nosrc
