...
% todo sagen wofür die Heuristiken genau entworfen sind
...
% refine Das hier auch in den Text einbauen?
% Es gibt auch die Gestaltungsgesetze von Shneiderman oder das Honeycomb Modell von Morville, die als Bewertungsgrundlage dienen können. % src: Shneiderman 1998; Morville 2004
% Da in dieser Arbeit jedoch nach Nielsens Heuristiken evaluiert wird und die Modelle in ihren Inhalten sehr ähnlich sind, werden sie an dieser Stelle nicht weiter ausgeführt. 



Das UX Honeycomb von Peter Morville beschreibt sieben Facetten der User Experience: Nützlichkeit (useful), Nutzbarkeit (usable), Begehrenswert (desirable), Findbarkeit (findable), Zugänglichkeit (accessible), Glaubwürdigkeit (credible) und Wertvoll (valuable). % src: UX Honeycomb, Morville 2004

Nützlichkeit bedeutet, dass das System einen Zweck erfüllt und den Nutzern hilft, ihre Ziele zu erreichen. Nutzbarkeit bezieht sich darauf, wie einfach und effizient das System zu bedienen ist. Begehrenswert beschreibt die emotionale Anziehungskraft des Systems, also wie ansprechend und attraktiv es für die Nutzer ist. % src: UX Honeycomb, Morville 2004

Der klassische Ablauf einer heuristischen Evaluation sieht vor, dass mehrere Experten das System unabhängig voneinander prüfen und Verstöße gegen diese Heuristiken protokollieren. Anschließend werden die Ergebnisse konsolidiert und nach Schweregrad bewertet. % src: Nielsen 1994 
% refine, kp welche von Nielsen, aber sind ja nur so 5
Dies ermöglicht eine effiziente Identifikation von Usability-Problemen bereits in frühen Entwicklungsphasen, ohne dass aufwendige Nutzertests notwendig sind.