...
Ein zentraler Aspekt ist die Aufgabenangemessenheit, die fordert, dass ein System den Nutzer effektiv und effizient bei der Erledigung seiner Aufgaben unterstützt, ohne unnötige Barrieren aufzubauen. 

Eng damit verbunden ist die Selbstbeschreibungsfähigkeit, die sicherstellt, dass dem Nutzer zu jeder Zeit klar ist, in welchem Zustand sich das System befindet und welche Schritte als nächstes erwartet werden. Dies korrespondiert direkt mit dem Einsatz von Signifiers und Feedback zum Bilden des Conceptual Models der Nutzer. So wird die Bedienung des Systems transparenter und verständlicher.

Des Weiteren wird Erwartungskonformität gefordert, was bedeutet, dass sich das System konsistent verhalten und den mentalen Conceptual Models der Nutzer entsprechen sollte. Wenn das Mapping und die Abläufe den Erfahrungen aus der physischen Welt oder bekannten Anwendungen gleichen, finden sich Nutzer schneller zurecht.

Dies trägt auch zur Lernförderlichkeit bei, da klare Affordances und verständliches Feedback dem Nutzer helfen, schnell ein korrektes Conceptual Modell aufzubauen und das System sicher zu bedienen. % todo Quelle finden

Ein weiteres Prinzip ist die Steuerbarkeit, die dem Nutzer die Kontrolle über den Dialog überlässt, sodass Prozesse gestartet, unterbrochen oder in ihrer Geschwindigkeit angepasst werden können.

Da trotz guten Designs Fehler auftreten können, ist Fehlertoleranz essenziell. Ein System nach DIN EN ISO 9241-110 fängt fehlerhafte Eingaben ab oder ermöglicht eine einfache Korrektur, ohne dass Arbeitsergebnisse verloren gehen.

Schließlich fordert die Norm Individualisierbarkeit, um das System an unterschiedliche Voraussetzungen und Vorlieben der Nutzer anpassen zu können und so den spezifischen Nutzungskontext zu berücksichtigen. Dazu gehört zum Beipsiel die Barrierefreiheit und ein Dark Mode. (vgl. DIN EN ISO 9241-110, 2008, S. 8ff.).
...
Der Cognitive Walkthrough fokussiert sich auf die Erlernbarkeit des Systems. Experten simulieren schrittweise die Interaktion eines Nutzers und prüfen an jedem Schritt, ob der Nutzer die richtige Handlung erkennen und ausführen kann. %  ~ vgl. Polson et al., 1992 - https://doi.org/10.1016/0020-7373(92)90039-N ; Wharton et al., 1994 - https://dl.acm.org/doi/10.5555/189200.189218
