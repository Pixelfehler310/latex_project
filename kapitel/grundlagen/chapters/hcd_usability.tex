...
% todo bessere Überleitung zu diesem Abschnitt finden

Die Usability und User Experience eines Systems können mit verschiedenen Methoden evaluiert und bewertet werden. Grundsätzlich unterscheidet man zwischen nutzerbasierten und expertenbasierten Evaluationsmethoden. % src: ISO 9241-210, p. 17

% todo vor und nachteile der beiden ansätzen noch anreißen (nutzerbasiert: realistisch, aber aufwendig udn teuer; expertenbasiert: schnell und "günstig", aber subjektiv)

Expertenbasierte Evaluationsmethoden beschreiben die Analyse und Bewertung des Systems durch Usability- und User-Experience-Experten. Meistens werden dafür wissenschaftlich fundierte Heuristiken oder Richtlinien verwendet um das System zu bewerten. % src: ISO 9241-210, p. 17 
, wie zum Beispiel Shneidermans acht goldene Regeln oder das Usability-Honeycomb von Morville. % src: Shneiderman 1998; Morville 2004

Ein guter wissenschaftlich fundierter Weg der expertenbasierten Evaluation ist die Heuristische Evaluation nach Jakob Nielsen. % nosrc

% todo sagen wofür die Heuristiken genau entworfen sind s. src: Nielsen 1994

Nielsen hat zehn allgemeine Usability-Heuristiken definiert, die als Bewertungsgrundlage für interaktive Systeme dienen können: % src: Nielsen 1994, updated. 2024
Diese Heuristiken decken sich stark mit den ISO-Prinzipien und den psychologischen Grundlagen von Norman, bieten aber ein konkreteres Werkzeug für die Bewertung.

% todo immer das zugrundeliegende interaktions / psychologische prinzip referenzieren
% todo latex struktur mit items

% * definition heuristics auch in ISO 9241-210

% ! todo analyse nielsens src for upper concepts as well, valuable source! and later on for implementations, we can use the tips as src or reason why we do smth

1. Sichtbarkeit des Systemstatus
Das Design sollte den Nutzern jederzeit Feedback über den aktuellen Zustand des Systems geben.
2. Übereinstimmung zwischen System und realer Welt
Das Design sollte dem Nutzer vertraute Konzepte und Begriffe aus der realen Welt.
3. Nutzerkontrolle und Freiheit
Nutzer sollten die Kontrolle über das System haben und Aktionen rückgängig machen, abbrechen oder wiederholen können.
4. Konsistenz und Standards
Das Design sollte konsistent sein und etablierte Standards und Konventionen einhalten. Dazu gehören zum Beispiel etablierte Symbole, Farbcodes oder Layouts, die den Nutzern bereits aus anderen Softwaresystemen vertraut sind.
5. Fehlervermeidung
Gutes Design hat nicht nur gute Fehlermeldungen, sondern ist so designt, dass Fehler erst gar nicht auftreten können, weil der Nutzer durch Constraints und dem Abfangen von Fehlerzuständen daran gehindert wird, falsche Aktionen auszuführen.
6. Erkennen statt Erinnern
Alle Elemente, Aktionen und Optionen sollten sichtbar sein, sodass der Nutzer sie leicht finden und auswählen kann, ohne sich an Informationen aus vorherigen Interaktionen erinnern zu müssen. Das reduziert die kognitive Last.
7. Flexibilität und Nutzungseffizienz
Das Design sollte sowohl für Anfänger als auch für erfahrene Nutzer geeignet sein. Es sollte Abkürzungen und Anpassungsmöglichkeiten bieten, um die Effizienz der Nutzung zu steigern. Diese sollten aber nicht die Verständlichkeit für Anfänger beeinträchtigen.
8. Ästhetik und minimalistisches Design
Unnötige Informationen und Designelemente sollten vermieden werden, um die Aufmerksamkeit der Nutzer auf die wesentlichen Funktionen zu lenken.
9. Hilfe bei Fehlern
Die Fehlermeldungen in einem System sollten klar und präzise sein und dem Nutzer helfen, das Problem zu verstehen und zu beheben. Sie sollten nicht nur den Fehler beschreiben, sondern auch mögliche Lösungen anbieten.
10. Hilfe und Dokumentation
Das beste System benötigt keine Dokumentation, aber wenn sie notwendig ist, sollte sie leicht zugänglich, fokussiert auf die Nutzeraufgaben und leicht verständlich sein. 

% src: Nielsen 1994, updated. 2024 (! teilweise direct übersetzt, teilweise etwas freier formuliert) 
% addsrc: nielsens primärquelle 1994a und 1994b aus obigem artikel
% ? Wie quotet man das dann?

Der klassische Ablauf einer heuristischen Evaluation sieht vor, dass mehrere Experten das System unabhängig voneinander prüfen und Verstöße gegen diese Heuristiken protokollieren. Anschließend werden die Ergebnisse konsolidiert und nach Schweregrad bewertet.
% addsrc, kp welche quelle von Nielsen (1994), aber sind ja nur so 5
Eine heuristische Evaluation nach Nielsen liefert einem nur implizit ob ein System eine gute User Experience oder Usability hat. Werden viele Fehler oder Probleme angemerkt ist die Usability und User Experience des Systems wahrscheinlich schlecht. Werden wenige oder keine Probleme gefunden, ist die Usability und User Experience wahrscheinlich gut. % nosrc
Es kann aber auch verzerrt werden durch besonders erfahrene oder genaue Experten, die mehr Probleme finden als andere. % nosrc
Der Kerngewinn der heuristischen Evaluation liegt also weniger im beantworten der Frage, ob ein System eine gute Usability hat, sondern vielmehr darin zu belegen, warum ein System eine gute oder schlechte User Experience bietet.

Um herauszufinden, ob ein System tatsächlich eine gute Usability und User Experience bietet und Vergleichswerte zu erhalten, sind nutzerbasierte Evaluationsmethoden notwendig. % nosrc

Nutzerbasierte Evaluationsmethoden hingegen beziehen tatsächliche Nutzer in den Evaluationsprozess mit ein. % verify: ISO 9241-210, p. 17
% addsrc
Eine häufig verwendete Methode zur nutzerbasierten Evaluation ist die System Usability Scale (SUS). % verify: Brooke 1996

Die SUS ist ein standardisierter Fragebogen, der aus zehn Aussagen besteht, die die Nutzer nach der Verwendung des Systems bewerten. % src: SUS
Sie können dabei auf einer Skala von 1 bis 5 angeben, inwieweit sie den Aussagen zustimmen oder nicht zustimmen. % src: SUS
Die Aussagen decken verschiedene Aspekte der Usability ab, wie z.B. die Einfachheit der Nutzung, die Lernbarkeit, die Effizienz und die Zufriedenheit der Nutzer. % src: SUS

Die Ergebnisse der SUS werden zu einem Gesamtwert zusammengefasst, der zwischen 0 und 100 liegt. % src: SUS
Ein höherer Wert deutet auf eine bessere Usability hin. % src: SUS

% TODO bei der Ausführung und Bewertung der SUS einfach Sagen "Die Berechnung und Interpretation der SUS wurde gemäß den Richtlinien von Brooke (1996) durchgeführt."

% TODO: SUS ggf mit anderen Methoden vergleichen und vor- und nachteile von SUS gegenüber anderen nutzerbasierten methoden (z.B. task-based testing, interviews, etc.)
% TODO vor und nachteile von nutzerbasierter Evaluation vs expertenbasierter Evaluation

Mit einer Kombination aus experten- und nutzerbasierten Evaluationsmethoden kann ein umfassendes Bild der Usability und User Experience eines Systems gewonnen werden. % nosrc
Während die Nutzerbasierte Evaluation Stärken und Probleme des Systems aufzeigt, kann die heuristische Evaluation helfen, die Ursachen dieser Probleme zu identifizieren und konkrete Verbesserungsvorschläge zu machen. % nosrc
Durch die Anwendung beider Methoden können Entwickler sicherstellen, dass ihre Systeme nicht nur funktional sind, sondern auch eine gute Usability und User Experience bieten. % nosrc

% TODO: Check if mental and conceptional model are the same (probably not!: mental: USer; conceptional: Designer). Clarify difference if needed
